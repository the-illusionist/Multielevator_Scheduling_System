...
class Panel(object):
    ...
    def __init__(self,canvas,elevator_list):
        ...
        # #START BUTTON
        # self.button_start   = canvas.create_rectangle(450,150,550,190,fill="#A9A9A9")
        # self.button_start_id = canvas.create_text(460, 160, anchor="nw", activefill="red")
        # canvas.itemconfig(self.button_start_id, text="Start Simulation")
        # canvas.tag_bind(self.button_start, '<Button-1>', lambda x: self.SimulateButtonClicked("Sta"))
        # canvas.tag_bind(self.button_start_id, '<Button-1>', lambda x: self.SimulateButtonClicked("Sta"))

        # #STOP BUTTON
        # self.button_stop   = canvas.create_rectangle(450,210,550,250,fill="#A9A9A9")
        # self.button_stop_id = canvas.create_text(460, 220, anchor="nw", activefill="red")
        # canvas.itemconfig(self.button_stop_id, text="Stop Simulation")
        # canvas.tag_bind(self.button_stop, '<Button-1>', lambda x: self.SimulateButtonClicked("Sto"))
        # canvas.tag_bind(self.button_stop_id, '<Button-1>', lambda x: self.SimulateButtonClicked("Sto"))
    ...
    # def SimulateButtonClicked(self,event):
    #     global sim
    #     if(event=="Sta" and sim==False):
    #         sim=True
    #     elif(event=="Sto" and sim==True):
    #         sim=False
